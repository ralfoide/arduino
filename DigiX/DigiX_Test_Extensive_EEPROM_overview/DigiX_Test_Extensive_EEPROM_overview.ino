...
void loop()
{
  ...
  if(test == 1) //only run it once
  {
     ...
     SerialUSB.println("//byte-wise writing/reading");
     for(int i = 0; i < 32; i++)
     { 
        blink();
     ...
     for(int i = 0; i < 32; i++)
     {
        ...
        SerialUSB.print("original data= ");
        SerialUSB.print(i);
        SerialUSB.print(" read_back= ");
        SerialUSB.println(data_back);
     }
     
     
     //page-wise writing/reading
     SerialUSB.println("//page-wise writing/reading");
     ...
     {
        blink();
       SerialUSB.print("Read Page= ");
       SerialUSB.println(data_output[j]);  // Print array
     }
     
     //write/read 32 bit integer
     SerialUSB.println("//write/read 32 bit integer");
     ...
     SerialUSB.print("Integer: in = ");
     SerialUSB.print(original_int);
     SerialUSB.print(" / out = ");
     SerialUSB.println(original_int_output); 
     
     //write/read 10/12 bit sensor data
     SerialUSB.println("//write/read 10/12 bit sensor data");
     ...
     SerialUSB.print("Sensordata: in = ");
     SerialUSB.print(original_sensor);
     SerialUSB.print(" / out = ");
     SerialUSB.println(original_sensor_output);
