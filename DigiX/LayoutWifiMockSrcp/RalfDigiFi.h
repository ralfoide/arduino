...
#define DIGIFI_CONNECTED_NOT 0
#define DIGIFI_CONNECTED 1
#define DIGIFI_CONNECTED_BECAUSE_DATA 1
#define DIGIFI_CONNECTED_BECAUSE_RECENT 2
...
class DigiFi : public Client
{
    public:
        ...
        */
        ...
        // RM Changed from private to public
