...
{
    syslog_bus(bus, DBG_DEBUG, "read PCF ");
...
{
    syslog_bus(bus, DBG_DEBUG, "write PCF ");
...
{
    int addr, value = 0;
    syslog_bus(5, DBG_DEBUG, "select bus ");
    ...
    syslog_bus(5, DBG_DEBUG, "power ON/OFF ");
        value = 64;
...
{
    syslog_bus(bus, DBG_DEBUG, "handle GA set  ");
    I2C_ADDR i2c_addr;
    I2C_VALUE i2c_val;
    I2C_VALUE value;
    I2C_PORT port;
...
{
    syslog_bus(5, DBG_DEBUG, "readconf i2c device  ");
...
{
    syslog_bus(bus, DBG_DEBUG, "init  i2c device  ");
    int fd;
...
int init_bus_I2C_DEV(bus_t i)
{
    ...
    syslog_bus(5, DBG_DEBUG, "init  i2c bus  ");
