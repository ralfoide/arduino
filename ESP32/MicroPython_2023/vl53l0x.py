...
class VL53L0X:
    ...
    def _read_u8(self, address):
        ...
        self._i2c.readfrom_mem_into(self._i2c_address, address, self._BUFF_8)
        return self._BUFF_8[0]
    ...
    def _read_u16(self, address):
        ...
        self._i2c.readfrom_mem_into(self._i2c_address, address, self._BUFF_16)
        return (self._BUFF_16[0] << 8) | self._BUFF_16[1]
    ...
    def _write_u8(self, address, val):
        ...
        self._BUFF_8[0] = val & 0xFF
        self._i2c.writeto_mem(self._i2c_address, address, self._BUFF_8)
    ...
    def _write_u16(self, address, val):
        ...
        self._BUFF_16[0] = (val >> 8) & 0xFF
        self._BUFF_16[1] = val & 0xFF
        self._i2c.writeto_mem(self._i2c_address, address, self._BUFF_16)
